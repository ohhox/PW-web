                ...
                <div class=" container ">
                    <div class="newsevent">
                        <h4 class="contents-title">
                            ...
                            <a href="mitting_room.php" class="text-white">
                                ...
                                <div class="col-md-12 ">
                                    <div class="row blox" href="hotel_detail.php?id=<?= $row['room_id'] ?>" style="height: auto0">
                                        ...
                                        <div class="col-md-4 roomDetailMain">
                                            ...
                                            <div class="price" style="font-weight: bold;"> อาคาร <?= ($row['building']); ?> </div> 
                                            <div class="price"  style="font-weight: bold;"> ความจุ <?= number_format($row['numberofguests']); ?> ที่นั่ง </div>
