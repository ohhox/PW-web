...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    $data = $fn->mysqli->query("SELECT * FROM mitting WHERE room_id='{$_GET['id']}' ");
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form autocomplete="off"  action="op_mitting.php?op=<?= isset($_GET['id']) && !empty($_GET['id']) ? 'updateRoom&id=' . $_GET['id'] : 'newroom' ?>" method="post" multipart='' enctype="multipart/form-data">
                                    <div class="row clearfix">
                                        <div class="col-md-9">
                                            <b> ชื่อห้องประชุม *</b>
                                            <div class="input-group colorpicker">
                                                <div class="form-line">
                                                    <input type="text" required class="form-control" name="room_name"  value="<?= isset($data['room_name']) ? $data['room_name'] : '' ?>" placeholder="ชื่อห้องประชุม">
                                                </div>

                                            </div>

                                            <b> เลขที่ห้องประชุม *</b>
                                            <div class="input-group colorpicker">
                                                <div class="form-line">
                                                    <input type="text" required class="form-control" name="room_code" placeholder="เลขที่ห้องประชุม" value="<?= isset($data['room_code']) ? $data['room_code'] : '' ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="input-group colorpicker">
                                                <div class="form-line">
                                                    <input type="text" required class="form-control" name="numberofguests" placeholder="จำนวนที่นั่ง" value="<?= isset($data['numberofguests']) ? $data['numberofguests'] : '' ?>">
                                                </div>
                                            ...
                                            <div class="input-group colorpicker">
                                                <div class="form-line">
                                                    <input type="text" required class="form-control" name="building" placeholder="อาคาร/สถานที่" value="<?= isset($data['building']) ? $data['building'] : '' ?>">
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <b>รูปภาพห้องประชุม(รูปหลัก) * <br/> <small>(ขนาดของรูป 1024px X 730px) </small> </b> <br/>
                                            ...
                                            <b>อัลบั้มรูปภาพ <small> (ขนาดของแต่ละภาพไม่ควรเกิน 1MB </small>) </b> <br/>
                                            <small style="color: #0000ff">ควรทำการ resize รูปภาพก่อนนำเข้าระบบ</small>
...
//                                                        $fn->s($resx);
                                                    ...
                                                    <div class="col-md-5" style="border: 1px solid #b1b1b1;overflow: hidden;margin-right: 10px;padding: 0px;">
                                                                <div style="display: flex;justify-content: space-between;">
                                                                    ...
                                                                    <a  href="../hotel_room/<?= $resx['image_name'] ?>" target="_BLANK" style="display: block;height:100px;flex: 1;overflow: hidden">
