                                ...
                                <tbody>
                                    ...
                                    while ($row = $newsList->fetch_object()) {
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <a class="btn btn-warning" href="publicnews_form.php?id=<?= $row->news_id; ?>">แก้ไข</a> 
                                                <a  href="op_news.php?op=removepublicNews&id=<?= $row->news_id; ?>" class="btn btn-danger removeNews">ลบ</a>
