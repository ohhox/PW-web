                                        ...
                                        <div >
                                            <div> 
                                                <div class="input-group ">
                                                    <label>รูปนักศึกษา</label>
                                                    <input type="file"  name="student_image" >
                                                    <?php
                                                    if (isset($StudentYear) && !empty($StudentYear->student_image)) {
                                                        ?>
                                                        <div>
                                                            <a target="_BLANK" href="../gallery/<?= $StudentYear->student_image ?>"> <img src="../gallery/thm/<?= $StudentYear->student_image ?>" /> </a>
                                                        </div>
                                                    <?php } ?>
                                                </div>
                                                <div class="input-group ">
                                                ...
                                                <div class="input-group ">
                                                    ...
                                                    <input type="text"  name="password" class="form-control" value="<?= isset($StudentYear) ? $StudentYear->password : '' ?>" >
                                                </div>
                                                <div class="input-group ">
