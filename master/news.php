                                ...
                                <tbody>
                                    ...
                                    while ($row = $newsList->fetch_object()) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="gallery.php?id=<?= $row->news_id; ?>">อัลบั้ม</a>  
                                                <a class="btn btn-warning" href="news_form_edit.php?id=<?= $row->news_id; ?>">แก้ไข</a>  
                                                <a class="btn btn-danger" href="op_news.php?op=removeNews&id=<?= $row->news_id; ?>" class="color-red removeNews">ลบ</a>
